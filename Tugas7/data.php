...
<body>
    ...
    <?php
    $sm1 = ['nim' => '2001010034', 'nama' => 'Andi', 'nilai' => 95];
    ...
    ?>
    <h2 style="text-align: center; margin-top: 2rem;">DAFTAR NILAI MAHASISWA</h2>
    <table border="1" cellpadding="8" cellspacing="2" width="100%">
        <thead>
            <tr bgcolor="#14213d" style="color: #fff;">
                <?php
        ...
        <tfoot>
            ...
            ?>
                <tr bgcolor="#495057" style="color: #fff;">
                    <td colspan="3"><?= $ket ?></td>
